...
if (isset($_POST['submit'])) {
	...
	$stmt->bind_param("ss", $puname, $ppwd);
	...
	if ($num > 0) {
		...
		// Prepare an insert statement for successful login log
		...
		// For storing log if user login is unsuccessful
		$_SESSION['login'] = $_POST['username'];
		$uip = $_SERVER['REMOTE_ADDR'];
		$status = 0;

		// Prepare an insert statement for unsuccessful login log
